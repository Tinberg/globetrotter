            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <img src="${post.authorAvatar || '/images/profileimage.jpg'}" class="post-profile-image rounded-circle me-3" alt="Profile image">
                        <div class="d-flex flex-column">
                            <p class="mb-0 fs-6 fw-light">
                                Posted by <span class="post-user-name fw-normal">${post.authorName || 'Unknown'}</span>
                            </p>
                            <p class="card-text fw-light">
                                <i class="fa-solid fa-heart text-primary"></i>
                                <span class="mx-1">${post._count.likes || 0}</span> | <span class="post-comments mx-1">${post._count.comments || 0}</span> comments
                            </p>
                        </div>
                    </div>
                </div>
