...
//     const posts = await fetchPostsByUserName(userName);
//     displayPosts(posts, profile);
//     // addeventlister click to togglefollow
//     document.getElementById('followOrUnfollow').addEventListener('click', () => toggleFollow(userName));
//   } catch (error) {
//     console.error("Failed to load user profile or posts:", error);
...
//     // Toggle follow status locally based on button text
//     if (followButton.textContent.trim() === 'Follow') {
//       try {
//         await followUser(username);
//         followButton.textContent = 'Unfollow';
